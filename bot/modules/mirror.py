    ...
    def onUploadComplete(self, link: str, size):
        with download_dict_lock:
            ...
            if SHORTENER is not None and SHORTENER_API is not None:
                ...
                buttons.buildbutton("☁️Softfreakz TD Link☁️", surl)
            else:
                buttons.buildbutton("☁️Softfreakz TD Link☁️", link)
            ...
            if INDEX_URL is not None:
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    ...
                    buttons.buildbutton("⚡Softfreakz Drive Index Link⚡", siurl)
                else:
                    buttons.buildbutton("⚡Softfreakz Drive Index Link⚡", share_url)
